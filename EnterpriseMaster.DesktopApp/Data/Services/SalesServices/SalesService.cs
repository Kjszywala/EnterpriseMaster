...
namespace EnterpriseMaster.DesktopApp.Data.Services.SalesServices
{
    public class SalesService
    {
        ...
        public async Task<List<Refunds>> GetAllRefundsAsync()
        {
            try
            {
                return (await refudsServices.GetAllAsync()).Where(item => item.IsActive == true && item.Company == Config.CompanyId).ToList();
            }
            catch (Exception e)
            {
        ...
        public async Task<bool> AddRefundsAsync(Refunds refunds)
        {
            try
            {
                refunds.Company = Config.CompanyId;
        ...
        public async Task<List<Returns>> GetAllReturnsAsync()
        {
            try
            {
                return (await returnServices.GetAllAsync()).Where(item => item.IsActive == true && item.Company == Config.CompanyId).ToList();
            }
            catch (Exception e)
            {
                await errorLogsServices.AddAsync(new ErrorLogs() { Date = DateTime.Now, Message = e.Message, Exception = e.StackTrace });
        ...
        public async Task<bool> AddReturnsAsync(Returns returns)
        {
            try
            {
                returns.Company = Config.CompanyId;
        ...
        public async Task<List<Shippers>> GetAllShippersAsync()
        {
            try
            {
                return (await shippersServices.GetAllAsync()).Where(item => item.IsActive == true && item.Company == Config.CompanyId).ToList();
            }
            catch (Exception e)
            {
                await errorLogsServices.AddAsync(new ErrorLogs() { Date = DateTime.Now, Message = e.Message, Exception = e.StackTrace });
        ...
        public async Task<bool> AddShipperAsync(Shippers shippers)
        {
            try
            {
                shippers.Company = Config.CompanyId;
