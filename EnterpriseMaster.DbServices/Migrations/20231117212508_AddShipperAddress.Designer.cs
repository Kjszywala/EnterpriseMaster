...
namespace EnterpriseMaster.DbServices.Migrations
{
    ...
    [Migration("20231117212508_AddShipperAddress")]
    partial class AddShipperAddress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EnterpriseMaster.DbServices.Models.Database.Invoices", b =>
                {
                    ...
                    b.HasOne("EnterpriseMaster.DbServices.Models.Database.PurchaseOrders", null)
                        .WithMany("Invoices")
                        .HasForeignKey("PurchaseOrdersId");

                    b.HasOne("EnterpriseMaster.DbServices.Models.Database.SalesOrders", null)
                        .WithMany("Invoices")
